...
/*
    yes, static block do executes before main() - but only when the class containing
    the static block is first loaded. And the class is loaded only when it is first
    accesed.
    ...
    *It runs: System.out.println("From main :- ");
     ->No refernce to Geeks yet, so static block of Geeks doesn't run yet.
    ...
    * The moment you write: Geeks.a -> now JVM sees that geeks class is needed
    ...
    Therefore, output of above code is :-
    From main :-
