...
//extend keyword is used to inherit property from shape class
...
public class Test 
{
    public static void main(String[] args){
        ...
        e1.area();
        e1.area(10, 12);
        e1.area(10); // Multi level Inheritance : EquiTriangle is inherit by Triangle.

        System.err.println("-----------------------------------------------");

        Circle c1 = new Circle();
        c1.area();
        c1.area(4);  // Hierarchical Inheritance : Circle is also inherit by Shape.
    }
}
